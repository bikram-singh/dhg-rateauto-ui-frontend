      ...
      <div style={{ position:"fixed", inset:0, overflow:"hidden", pointerEvents:"none" }}>
        {[...Array(5)].map((_, i) => (
          <div key={i} style={{
            ...
            borderRadius:"50%", border:"1px solid rgba(79,195,247,0.07)",
            top:`${8+i*9}%`, left:`${4+i*14}%`,
          }}/>
        ))}
      </div>
      ...
      <div style={{ width:"100%", maxWidth:"420px", padding:"20px", position:"relative", zIndex:1 }}>
        ...
        <div style={{ textAlign:"center", marginBottom:"32px" }}>
          <div style={{ display:"inline-flex", alignItems:"center", justifyContent:"center",
            ...
            boxShadow:"0 8px 32px rgba(21,101,192,0.3)", marginBottom:"16px" }}>
            <svg viewBox="0 0 80 90" width="56" height="63" fill="none">
              <defs>
                <linearGradient id="lSG" x1="0" y1="0" x2="80" y2="90" gradientUnits="userSpaceOnUse">
                  <stop offset="0%" stopColor="#00BCD4"/><stop offset="50%" stopColor="#29B6F6"/>
                  <stop offset="100%" stopColor="#1565C0"/>
                </linearGradient>
                <linearGradient id="lCG" x1="0" y1="0" x2="40" y2="55" gradientUnits="userSpaceOnUse">
                  <stop offset="0%" stopColor="#4FC3F7"/><stop offset="100%" stopColor="#1565C0"/>
                </linearGradient>
              </defs>
        ...
        <div style={{ background:"rgba(255,255,255,0.07)", backdropFilter:"blur(20px)",
          border:"1px solid rgba(255,255,255,0.15)", borderRadius:"20px", padding:"32px" }}>
          <h2 style={{ color:"#fff", fontSize:"18px", fontWeight:"600",
            margin:"0 0 24px", textAlign:"center" }}>Sign in to your account</h2>
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ marginBottom:"24px" }}>
              ...
              <div style={{ position:"relative" }}>
                ...
                <input type={showPass ? "text" : "password"} value={password}
                  ...
                  style={{ width:"100%", padding:"12px 44px 12px 40px",
                    background:"rgba(255,255,255,0.08)", border:"1px solid rgba(255,255,255,0.2)",
                    borderRadius:"10px", color:"#fff", fontSize:"14px",
                    outline:"none", fontFamily:"inherit", boxSizing:"border-box" }}/>
            ...
            <button type="submit" disabled={loading}
              style={{ width:"100%", padding:"13px",
                ...
                fontFamily:"inherit", boxShadow: loading ? "none" : "0 4px 16px rgba(21,101,192,0.4)" }}>
          ...
          <div style={{ marginTop:"20px", padding:"12px 14px",
            ...
            borderRadius:"10px", fontSize:"12px", color:"rgba(255,255,255,0.5)", textAlign:"center" }}>
